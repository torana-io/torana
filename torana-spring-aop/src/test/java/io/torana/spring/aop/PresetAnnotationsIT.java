...
/**
 * Integration test for preset audit annotations (@AuditedCreate, @AuditedUpdate, @AuditedDelete).
 *
 * <p>This test verifies:
 * - Preset annotations work end-to-end with real database
 ...
 *
 * <p>Uses TestContainers with PostgreSQL for realistic integration testing.
 */
@Testcontainers
@SpringJUnitConfig(PresetAnnotationsIT.TestConfiguration.class)
class PresetAnnotationsIT {
        ...
        return jdbcTemplate.query(
                ...
                (rs, rowNum) -> {
                    ...
                    return AuditEntry.builder()
                            ...
                            .target(
                                    new io.torana.api.model.Target(
    ...
    static class TestConfiguration {
        ...
        public JdbcAuditWriter jdbcAuditWriter(JdbcTemplate jdbcTemplate) {
            return new JdbcAuditWriter(
                    jdbcTemplate, new PostgreSqlDialect(), "audit_entries");
        }
        ...
        @Bean
        public AuditedActionAspect auditedActionAspect(AuditPipeline auditPipeline) {
            return new AuditedActionAspect(auditPipeline);
        }
